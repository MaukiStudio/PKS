...
class TagMatrixTest(APITestBase):
    ...
    def test_likelyhood_property(self):
        ...
        self.assertAlmostEqual(TagMatrix.likelyhood(tag2, tag1), (0 + (0+0.5)/(0+1.0))/(0+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag1, tag2), (0 + (0+0.5)/(0+1.0))/(0+1.0), delta=0.000001)
        place2 = Place.objects.create()
        uplace2 = UserPlace.objects.create(place=place2)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag2, tag1), (0 + (0+0.5)/(0+1.0))/(0+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag1, tag2), (0 + (0+0.5)/(0+1.0))/(0+1.0), delta=0.000001)
        uptag1 = UserPlaceTag.objects.create(tag=tag1, uplace=uplace1)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag2, tag1), (0 + (0+0.5)/(1+1.0))/(1+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag1, tag2), (0 + (1+0.5)/(1+1.0))/(0+1.0), delta=0.000001)
        uptag2 = UserPlaceTag.objects.create(tag=tag2, uplace=uplace2)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag2, tag1), (0 + (1+0.5)/(2+1.0))/(1+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag1, tag2), (0 + (1+0.5)/(2+1.0))/(1+1.0), delta=0.000001)
        uptag11 = UserPlaceTag.objects.create(tag=tag1, uplace=uplace2)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag2, tag1), (1 + (1+0.5)/(2+1.0))/(2+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood(tag1, tag2), (1 + (2+0.5)/(2+1.0))/(1+1.0), delta=0.000001)
    ...
    def test_likelyhood_negation_property(self):
        ...
        uptag1 = UserPlaceTag.objects.create(tag=tag1, uplace=uplace1)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (0+0.5)/(1+1.0))/(0+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (1+0.5)/(1+1.0))/(1+1.0), delta=0.000001)
        uptag2 = UserPlaceTag.objects.create(tag=tag2, uplace=uplace2)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (1 + (1+0.5)/(2+1.0))/(1+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (1+0.5)/(2+1.0))/(1+1.0), delta=0.000001)
        uptag11 = UserPlaceTag.objects.create(tag=tag1, uplace=uplace2)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(2+1.0))/(0+1.0), delta=0.26)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(2+1.0))/(1+1.0), delta=0.09)
        uptag3 = UserPlaceTag.objects.create(tag=tag3, uplace=uplace3)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(3+1.0))/(1+1.0), delta=0.000001)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(3+1.0))/(2+1.0), delta=0.000001)
        uptag4 = UserPlaceTag.objects.create(tag=tag4, uplace=uplace4)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(4+1.0))/(2+1.0), delta=0.07)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(4+1.0))/(3+1.0), delta=0.03)
        uptag5 = UserPlaceTag.objects.create(tag=tag5, uplace=uplace5)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(5+1.0))/(3+1.0), delta=0.07)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(5+1.0))/(4+1.0), delta=0.05)
        uptag6 = UserPlaceTag.objects.create(tag=tag6, uplace=uplace6)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(6+1.0))/(4+1.0), delta=0.07)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(6+1.0))/(5+1.0), delta=0.05)
        uptag7 = UserPlaceTag.objects.create(tag=tag7, uplace=uplace7)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag2, tag1), (0 + (1+0.5)/(7+1.0))/(5+1.0), delta=0.07)
        self.assertAlmostEqual(TagMatrix.likelyhood_negation(tag1, tag2), (1 + (2+0.5)/(7+1.0))/(6+1.0), delta=0.05)
