...
class CacheTest(APITestBase):
    ...
    def test_cache_get_or_create(self):
        self.assertEqual(cache_get(self.vd1, 'name1'), None)
        value, is_created = cache_get_or_create(self.vd1, 'name1', None, lambda x: 'value%d' % x, 1)
        self.assertEqual(value, 'value1')
        self.assertEqual(is_created, True)
        value, is_created = cache_get_or_create(self.vd1, 'name1', None, lambda x: 'value%d' % x, 11)
        self.assertEqual(value, 'value1')
        ...
        cache_get_or_create(self.vd1, 'name2', None, lambda x: 'value%d' % x, 2)
        value, is_created = cache_get_or_create(self.vd1, 'name1', None, lambda x: 'value%d' % x, 11)
        self.assertEqual(value, 'value11')
        self.assertEqual(is_created, False)
